...
const TOKEN_META = {
  ...
  JTO:    { styles:['momentum','growth','defensive','pullback','mean_reversion_small'], vol:'MED', minRegime:'EXPANSION' },
  PYTH:   { styles:['growth','pullback','defensive','mean_reversion_small'], vol:'MED',  minRegime:'EXPANSION' },
  RAY:    { styles:['momentum','growth','mean_reversion','pullback','defensive'], vol:'MED', minRegime:'EXPANSION' },
  ORCA:   { styles:['growth','momentum','pullback'], vol:'MED',  minRegime:'EXPANSION' },
  ...
  KMNO:   { styles:['momentum','growth'], vol:'HIGH', minRegime:'EXPANSION_CONFIRMED' },
};
