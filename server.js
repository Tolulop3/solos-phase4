...
const { runCycle, fetchWalletBalance, fetchTokenPrice, TIER1_TOKENS, TIER2_TOKENS } = require('./solos-engine');
...
function formatTradeProposal(result,inv,override,explCheck) {
  ...
  return [
    ...
    explCheck?.whaleProxy?'Whale: volume proxy (Phase 7 pending)':'',
